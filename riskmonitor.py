...
## สิ่งที่เพิ่มเข้ามาจากของแก

#**1. trade_count** — นับจำนวนเทรดทั้งหมด เอาไว้สรุปตอนจบ

#**2. ตาราง output** — แทนที่จะ print ธรรมดา จัดให้อ่านง่ายขึ้น
#```
#{'เทรด':^5}   →  จัดกึ่งกลาง 5 ช่อง
#{result:^+12.2f} →  + แปลว่าแสดง +/- เสมอ
#{portfolio:,.2f} →  , แปลว่าใส่ comma คั่นหลักพัน